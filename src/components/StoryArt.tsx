      ...
      <View
        ...
        style={[
          styles.blob,
          {
            ...
            height: dim * 0.72,
            borderRadius: dim,
            backgroundColor: dark ? "rgba(62,130,149,0.06)" : accentColor + "0A",
            top: 0,
            right: 0,
          },
        ]}
      ...
      <View
        ...
        style={[
          styles.blob,
          {
            ...
            height: dim * 0.55,
            borderRadius: dim,
            backgroundColor: dark ? "rgba(30,55,85,0.1)" : "rgba(30,55,85,0.03)",
            bottom: 2,
            left: 0,
          },
        ]}
      ...
      <View
        ...
        style={[
          styles.blob,
          {
            ...
            height: 18,
            borderRadius: 6,
            backgroundColor: dark ? "rgba(62,130,149,0.1)" : accentColor + "0D",
            top: 8,
            left: 10,
